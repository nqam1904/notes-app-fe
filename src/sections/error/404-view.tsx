...
export function View404() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center bg-gradient-to-br from-[#f5f7fa] to-[#c3cfe2]">
      <h1 className="text-[8rem] m-0 font-black bg-gradient-to-br from-[#667eea] to-[#764ba2] bg-clip-text text-transparent leading-none animate-[fadeInDown_0.6s_ease-out] md:text-[5rem]">
        {t('page.notFound.title')}
      </h1>
      <h2 className="text-[2rem] my-8 mb-4 font-semibold text-[#2d3748] animate-fadeIn md:text-2xl">
